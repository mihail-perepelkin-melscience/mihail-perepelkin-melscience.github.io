...
updateGlobalBufferAndViews(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 1622864;
...
// {{PRE_LIBRARY}}
  ...
  function _SetGroundFunction(pGroundFunction) {
      setGroundFunction = function(x) { dynCall_vi(pGroundFunction, x) };
    }

  function _SetLightFunction(pLightFunction) {
      setLightFunction = function(x) { dynCall_vf(pLightFunction, x) };
    }

  function _SetRestartFunction(pRestartFunction) {
      restartFunction = function() { dynCall_v(pRestartFunction) };
    }

  function _SetWaterFunction(pWaterFunction) {
      setWaterFunction = function(x) { dynCall_vf(pWaterFunction, x) };
    }
  ...
  var _fetch_work_queue=1098560;function __emscripten_get_fetch_work_queue() {
