...
updateGlobalBufferAndViews(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 1622256;
...
// {{PRE_LIBRARY}}
  ...
  function _SetSimpleCallback(pSimpleCallback) {
  
      firstCallback = function() { dynCall_v(pSimpleCallback) };
  
      //console.log("[JavaScript] SetSimpleCallback");
      
      //setTimeout(function () {
        // _v signature corresponds to `void ()`
      //  dynCall_v(pSimpleCallback);
      //}, 3000);
    }
  ...
  var _fetch_work_queue=1097952;function __emscripten_get_fetch_work_queue() {
