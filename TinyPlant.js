...
updateGlobalBufferAndViews(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 1651264;
...
// {{PRE_LIBRARY}}
  ...
  function _ReadSimulationParameters() {
      
      //var globalSimulationParameters = {scope: "local"};
      var str = JSON.stringify(globalSimulationParameters);
      //var str = "1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890";
      //var str = "1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890";
      //var str = JSON.stringify({foo: "bat"});
      //var str = "sdvsdv";
  ...
  function _SetPlayFunction(pPlayFunction) {
      playFunction = function(timeScale) { dynCall_vf(pPlayFunction, timeScale) };
    }

  function _SetRestartFunction(pRestartFunction) {
      restartFunction = function(timeScale) { dynCall_vf(pRestartFunction, timeScale) };
    }

  function _SetUpdateParametersFunction(pParametersFunction) {
      updateParametersFunction = function() { dynCall_v(pParametersFunction) };
    }
  ...
  var _fetch_work_queue=1126960;function __emscripten_get_fetch_work_queue() {
...
dynCall_dii = asm["dynCall_dii"];
dynCall_viid = asm["dynCall_viid"];
